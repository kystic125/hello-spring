...
class MemberServiceTest {
    ...
    public void 중복_회원_예외() {
        ...
        IllegalStateException e = assertThrows(IllegalStateException.class, () -> memberService.join(member2));// 성공 (중복이 있다는 소리)
...
/*        try {
            ...
            assertThat(e.getMessage()).isEqualTo("이미 존재하는 회원입니다.12"); // 실패
        }*/
